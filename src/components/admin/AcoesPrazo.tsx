...
export default function AcoesPrazo({ id, entidadeNome }: { id: string; entidadeNome: string }) {
      ...
      {aberto &&
        createPortal(
          <div
            ...
            className="z-[100] w-40 overflow-hidden rounded-lg border border-rule bg-white py-1 shadow-lg"
          >
            <Link
